...
public class AdminRewardsDbContext : Microsoft.EntityFrameworkCore.DbContext
{
    public AdminRewardsDbContext(Microsoft.EntityFrameworkCore.DbContextOptions<AdminRewardsDbContext> options) : base(options)
    {
    }
